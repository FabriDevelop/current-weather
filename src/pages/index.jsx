    ...
    <>
      ...
      <main className="flex items-center flex-col w-[90%] mx-auto max-w-5xl">
        <div className="flex flex-col md:flex-row items-center gap-20 lg:gap-32 my-2">
          <h1 className="font-semibold text-white flex items-center gap-1 mt-7 text-lg text-center">
            Current
          ...
          {!searchBarOpen ? (
            ...
            <form className="flex gap-2 self-end text-sm">
              <input
                type="text"
